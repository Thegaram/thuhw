...
def build_train(meta_model, variational, x, y):
    # shape: [batch_size]
    lower_bound = zs.variational.elbo(meta_model, {"x": x, "y": y}, variational=variational)
...
def main():
    ...
    meta_model = build_gen(y, x_dim, z_dim, n)
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1, epochs + 1):
            ...
            for t in range(iters):
                ...
                y_batch = t_train_one_hot[t * batch_size:(t + 1) * batch_size]
